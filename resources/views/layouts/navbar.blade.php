        ...
        <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="index.html">
                ...
                <b class="logo-icon p-l-10">
                    ...
                    <!-- Dark Logo icon -->
                    {{--<img src="/template/assets/images/logo-icon.png" alt="homepage" class="light-logo"/>--}}
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                src="/template/assets/images/users/1.jpg" alt="user" class="rounded-circle"
                                width="31"></a>
                    <div class="dropdown-menu dropdown-menu-right user-dd animated">
                        ...
                        <form class="form-horizontal m-t-20" id="loginform" method="POST" action="{{ route('logout') }}"
